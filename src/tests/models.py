...
class Point_2056_10fields(ComputedFieldsModel):
    ...
    field_0 = models.CharField(
        max_length=255, verbose_name=_("Field 0"), null=True, blank=True
    )
    field_1 = models.CharField(
        max_length=255, verbose_name=_("Field 1"), null=True, blank=True
    )
    field_2 = models.CharField(
        max_length=255, verbose_name=_("Field 2"), null=True, blank=True
    )
    field_3 = models.CharField(
        max_length=255, verbose_name=_("Field 3"), null=True, blank=True
    )
    field_4 = models.CharField(
        max_length=255, verbose_name=_("Field 4"), null=True, blank=True
    )
    field_5 = models.CharField(
        max_length=255, verbose_name=_("Field 5"), null=True, blank=True
    )
    field_6 = models.CharField(
        max_length=255, verbose_name=_("Field 6"), null=True, blank=True
    )
    field_7 = models.CharField(
        max_length=255, verbose_name=_("Field 7"), null=True, blank=True
    )
    field_8 = models.CharField(
        max_length=255, verbose_name=_("Field 8"), null=True, blank=True
    )
    field_9 = models.CharField(
        max_length=255, verbose_name=_("Field 9"), null=True, blank=True
    )
